define(
  "@widget/LAYOUT/c/bs-index3-98b416a8.js",
  [
    "radpack",
    "exports",
  ...
  function (e, t, a, r, o, l, n, i, c, s, g) {
    "use strict";
    class p extends (
    ...
    const { utils: C } = (global.Core || guac["@wsb/guac-widget-core"]).UX2;
    ...
    const { utils: w } = (global.Core || guac["@wsb/guac-widget-core"]).UX2;
    ...
    a._(Z, "propTypes", {
      ...
      a._(Z, "defaultProps", { isPriceShown: !0 });
    class Y extends (
      global.Core || guac["@wsb/guac-widget-core"]
    ...
    const me = {
      ...
      {
        fontScales: { DEFAULT_WEBSITE_FONT_SCALES: be },
        fontSizes: {
          XSMALL: ye,
          SMALL: fe,
          MEDIUM: Ce,
    ...
    function Le(e) {
      ...
      return -1 !== Re.indexOf(a) ? { deviceSize: t, newFontSize: a } : void 0;
    }
    function Ae(e, t) {
    ...
    const { CTAButton: Oe } = (global.Core || guac["@wsb/guac-widget-core"])
        .components,
      _e = { left: "flex-start", right: "flex-end", center: "center" };
    ...
    const { Link: Ne } = (global.Core || guac["@wsb/guac-widget-core"])
        .components,
      je = (global.PropTypes || guac["prop-types"]).shape({
        url: (global.PropTypes || guac["prop-types"]).string,
        pageId: (global.PropTypes || guac["prop-types"]).string,
        widgetId: (global.PropTypes || guac["prop-types"]).string,
        linkId: (global.PropTypes || guac["prop-types"]).string,
    ...
    const Ye = { left: "flex-start", right: "flex-end" };
    function Qe(e) {
      let {
        alignment: t = "center",
        heading: a,
      ...
      return (
        n &&
          (l = (global.React || guac.react).createElement(Ve, {
            key: "action",
            action: n,
          })),
        this.merge(
          {
            ...
            children: [
              !!c &&
                c.children &&
                (global.React || guac.react).createElement(Fe, {
                  key: "heading",
                  heading: c,
                }),
              !!s &&
    ...
    function at(e) {
      ...
      x && (P[":after"] = { content: '""', flex: "auto", maxWidth: "25%" }),
        f && (P.flexDirection += "-reverse"),
        w.applySizingStyles(P, e, this);
      const k = {
          gutter: b,
          bottom: m,
          equal: h,
        ...
        v = C ? { ...k, inset: C } : k,
        E = (global.React || guac.react).Children.toArray(u)
          .filter((e) => {
            const t = typeof e;
            return "object" === t
          ...
          .map((e, t) => {
            ...
            if (a && a.prototype) {
              if (a === T || a.prototype instanceof T)
                return (global.React || guac.react).cloneElement(e, v);
    ...
    function kt(e, t) {
      const a = (function (e) {
        if (!wt(e)) return null;
        const [t, a] = e.split("/:/");
        return { source: t, operations: Tt(a) };
      })(e);
      return null == a
        ? e
        : (function (e) {
            ...
            const r = a
              ...
              .join("/");
            return r ? t + "/:/" + r : t;
          })({ source: a.source, operations: [...a.operations, ...Pt(t)] });
    }
    function vt(e) {
      let t =
        arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "";
    ...
    function Et(e, t, a) {
      return "string" ==
        ...
        : null != a && a.fallbackBackgroundImageSrc
    ...
    const {
      ...
      Xt = [
        ...
        { min: 451, max: St, isMobile: !0, breakpoint: "@xs-only" },
        { min: Lt, max: At, isTablet: !0, breakpoint: "@sm-only" },
        { min: Mt, max: Bt, breakpoint: "@md-only" },
        { min: It, max: Ht, breakpoint: "@lg-only" },
        { min: zt, max: 1920, breakpoint: "@xl" },
        { min: 1921, breakpoint: "@xl" },
      ],
      Dt = [1, 2, 3],
      { HEADER: Ut } = (global.Core || guac["@wsb/guac-widget-core"]).constants
        .widgetTypes,
      { PUBLISH: Wt } = (global.Core || guac["@wsb/guac-widget-core"]).constants
        .renderModes;
    function Ot(e) {
      return e.replace(/"/g, '\\"');
    }
          ...
          (l ? [1] : Dt).forEach((l) => {
            const s = c.isMobile ? o : r,
              g = [
                ...
                `url("${Ot(
                  kt(e, { rs: c.max ? `w:${s * c.max * l},m` : "w:100%25" })
                )}")`,
              ]
                .filter(Boolean)
                .join(", ");
    ...
    function Vt(e) {
      ...
      const {
        ...
        { parallaxEnabled: v, position: E } = c,
        R = P === Wt,
        ...
        L = this.constructor.getMutatorDefaultProps(
          C,
          x
        ).showOverlayOpacityControls,
        A = this.constructor.getDefaultBackgroundFilter(C, x);
      let M = { ...(C !== Ut && { textShadow: l.a }), ...t };
      const B = {
      ...
      const X =
          a ||
          c.backgroundImage ||
          Et({ filter: A, additionalUrlParams: [m && "fx-bl=s:90"], ...c }),
        ...
        const e = () => {
            if (D === r.c) {
              ...
              return (global.Core || guac["@wsb/guac-widget-core"]).UX2.utils
                .getTheme(w, { category: "primary", section: "default" })
          ...
          t = (global.Core || guac["@wsb/guac-widget-core"]).UX2.utils
            .getTheme(w, { category: T, section: "overlay" })
            .mapPropValue("backgroundColor", e()),
          a = null == c ? void 0 : c.overlayAlpha;
        let o = 0;
        (o =
          a >= 0
            ? "HEADER" === C
              ? L
                ? a
                : this.constructor.getDefaultImageOverlayOpacity(C, x)
              : a
            : this.constructor.getDefaultImageOverlayOpacity(C, x)),
          (H = !0),
          (z = (e) => (
      ...
      const U =
          a || c.backgroundImage || !wt(X)
            ? {
                backgroundImage: [H && z(!0), `url("${Ot(X)}")`]
                  .filter(Boolean)
                  .join(", "),
              }
            : _t(
      ...
      if (
        (W &&
          ((B.backgroundImage = `${X}, url("${W.replace(/"/g, '\\"')}")`),
          p && (B.backgroundSize = `${B.backgroundSize}, ${p}`)),
        H && (B.backgroundSize = `auto, ${B.backgroundSize}`),
        !X.length && !W.length)
      )
        return this.merge({ style: M, children: u }, S);
      ...
      return (
        _
          ? (I = (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Block,
              { "data-lazybg": !0, className: "d-none", style: { ...B, ...U } }
            ))
          : (M = { ...M, ...B, ...U }),
        this.merge(
          {
    ...
    function jt(e) {
      ...
      const { treatmentLayout: l, overlayAlpha: n = 20 } = r;
      let i, c;
      const s = (a[l] || "").split("-");
      if ("Fit" === l || "Fill" === l)
        (i = {
        ...
        const e = { maxWidth: "60%", maxHeight: "60%" };
        (c = (global.React || guac.react).createElement("img", {
          ...
          "Blur" === l &&
            ((i.backgroundImage = `url("${t.replace(
              /"/g,
              '\\"'
            )}/fx-bl=s:90")`),
    ...
    const {
        renderModes: Gt,
        widgetTypes: { HEADER: qt, FOOTER: Zt },
      } = (global.Core || guac["@wsb/guac-widget-core"]).constants,
      Yt = [
        "theme",
        "category",
    ...
    function Qt(e) {
      ...
      return this.merge(
        ...
        (global._ || guac.lodash).pickBy(
          a,
          (e, t) => -1 !== Yt.indexOf(t) || 0 === t.indexOf("data-")
        )
      );
    }
    function Jt(e) {
    ...
    const { Link: ea } = (global.Core || guac["@wsb/guac-widget-core"])
        .components,
      ta = (global.PropTypes || guac["prop-types"]).shape({
        url: (global.PropTypes || guac["prop-types"]).string,
        pageId: (global.PropTypes || guac["prop-types"]).string,
        widgetId: (global.PropTypes || guac["prop-types"]).string,
        linkId: (global.PropTypes || guac["prop-types"]).string,
    ...
    class aa extends (global.React || guac.react).Component {
      render() {
        ...
        const h =
          ...
          b = r
            ? (global.React || guac.react).createElement(ea, { linkData: r }, m)
            : m;
        return (global.React || guac.react).createElement(
    ...
    const { getSelectedVideoProps: ra } = (
      global.Core || guac["@wsb/guac-widget-core"]
    ).utils;
    function oa(e) {
      let {
      ...
      const { widgetPreset: d } = this.base,
        h =
          t &&
          (global.React || guac.react).createElement(Fe, {
            style: g.size
              ? { width: "inherit", top: 0, "@sm": { position: "absolute" } }
              : {},
            key: "heading",
            heading: t,
          }),
      ...
      const y =
        ...
        f = "about1" === d ? { alignment: s } : {},
        C =
          n &&
          (global.React || guac.react).createElement(
            Ve,
            a.a({ key: "action", action: n }, f)
          ),
        x = [
          [
            t,
      ...
      if (E === L) {
        (T = (global.Core || guac["@wsb/guac-widget-core"]).UX2.Component
          .Background),
          (k = {
            overlay: R || r.A,
          ...
          (v || (M && M.image)) &&
            ((k.category = "accent"), (k.section = "overlay")),
          (P = (global._ || guac.lodash).merge(
            P,
            {
              width: "100%",
              height: "100%",
      ...
      return this.merge(
        { tag: T, group: "Content", groupType: "Card", children: w, style: P },
        k,
        u
      );
    }
    ...
    const { NEUTRAL: ma } = (global.Core || guac["@wsb/guac-widget-core"])
        .constants.categoryTypes,
      { EDIT: ba } = (global.Core || guac["@wsb/guac-widget-core"]).constants
        .renderModes,
    ...
    const { POPUP: Ca } = (global.Core || guac["@wsb/guac-widget-core"])
      .constants.widgetTypes;
    function xa(e) {
      let { style: t = {}, ...a } = e;
      const { widgetType: r } = this.base,
        o = {
          ...(r === Ca && { position: "absolute" }),
          padding: "0",
          top: "0",
          left: "0",
          bottom: "0",
    ...
    function Pa(e) {
      ...
      return this.merge({ children: s }, { style: { margin: "0 auto" } }, i);
    }
    const { DEFAULT: ka, ALT: va } = (
      global.Core || guac["@wsb/guac-widget-core"]
    ...
    function Ma(e) {
      ...
      const f = n ? { category: "accent" } : { category: b };
      let C = "accent";
      ...
      const T = {
          ...
          price: u,
          salePrice: d,
          titleProps: { align: o === Sa || o === La ? "center" : "left" },
          dataAids: h,
        },
        P = (global.React || guac.react).createElement(
          w,
              ...
              o !== Sa &&
                (global.React || guac.react).createElement(
                  ...
                  (global.React || guac.react).createElement(
                    (global.Core || guac["@wsb/guac-widget-core"]).UX2.Component
                      .CommerceCardContent,
                    a.a({}, T, { style: Aa.mobile })
                  )
                ),
              (global.React || guac.react).createElement(
                (global.Core || guac["@wsb/guac-widget-core"]).UX2.Component
                  .CommerceCardContent,
                a.a({}, T, { style: o === Sa ? {} : Aa.desktop })
              )
            )
          )
        );
      return this.merge({ children: P }, m);
    }
    function Ba(e) {
      let {
        imageList: t,
    ...
    function Ha(e) {
      ...
      const z = m
          ...
          : (global.React || guac.react).Fragment,
        X = m && { style: { flexGrow: 1, maxWidth: "100%" } },
        D = { cursor: "pointer", ...b },
        U = m ? { display: "flex", height: "100%", ...D } : { ...D },
        W = Boolean(o || g || p || u),
        O = {
          name: t,
          duration: a,
          ...
          cardSize: i,
          ratingsAlignLeft: B,
          titleProps: { align: !W && m ? "center" : "left" },
          isPriceShown: f,
        },
        _ = l
          ? (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Component
                .CommerceCardRibbon,
              { dataAids: A, cardSize: i, ribbonType: n },
              l
            )
          : null,
        V = S
          ? (global.React || guac.react).createElement(Ia, {
              dataAids: A,
              hoverButtonText: S,
              onHoverButtonClick: L,
            })
        ...
        N =
          u && u.length > 1
            ? (global.React || guac.react).createElement(Ba, {
                imageCropMethod: s,
                dataAids: A,
                imageList: u,
                imageShape: c,
      ...
      return this.merge({ children: j, style: U }, H);
    }
    (Ba.propTypes = {
      imageList: (global.PropTypes || guac["prop-types"]).array,
      imageShape: (global.PropTypes || guac["prop-types"]).string,
    ...
    const za = { vertical: "133%", square: "100%", horizontal: "75%" };
    function Xa(e) {
      let {
        children: t,
        backgroundColor: a,
      ...
      const M =
        ...
        I =
          w && u
            ? (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Block
            : (global.React || guac.react).Fragment,
        H = w && u && { style: L ? Da.priceRowLeft : Da.priceRowRight },
        z = Boolean(null == d ? void 0 : d.length),
        X = "large" === (null == m ? void 0 : m.xs),
        D = (global.React || guac.react).createElement(
          ...
          s &&
            (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Details
                .Minor,
              { style: Da.eyebrow, "data-aid": f.eyebrow },
              s
            ),
          (global.React || guac.react).createElement(
            (global.Core || guac["@wsb/guac-widget-core"]).UX2.Component
              .CommerceCardTitle,
            a.a({ title: t, isDigitalProduct: "digital" === c, dataAids: f }, S)
          ),
          o &&
            (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Details
                .Minor,
              { style: Da.eventDate, "data-aid": f.eventDate },
              o
            ),
          (global.React || guac.react).createElement(
            I,
            ...
            w &&
              (global.React || guac.react).createElement(
                  ...
                  .CommerceCardPriceDisplay,
                {
                  ...
                  dataAids: f,
                  isPriceFeatured: v,
                  styles: { marginRight: u ? "xxsmall" : "0" },
                }
              ),
            u &&
              (global.React || guac.react).createElement(
          ...
          g &&
            (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Details
                .Minor,
              { style: Da.footer, "data-aid": f.footer, alert: p },
              g
            ),
          x &&
            (global.React || guac.react).createElement(
          ...
          P &&
            (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element
                .MoreLink,
              { category: k, section: T ? "overlay" : "default", tag: "span" },
              P
            )
        );
      return this.Block(this.merge({ children: D, style: B }, A));
    }
    function Wa(e) {
      let {
        price: t,
      ...
      const u = r && { priceState: "expired" },
        ...
        h = (global.React || guac.react).createElement(
          (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Block,
          { active: !0, style: d.container },
          n &&
            (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Price,
              { children: n, featured: !0, style: d.duration }
            ),
          l &&
            (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Price,
              { children: l, featured: !0, style: d.range }
            ),
          (global.React || guac.react).createElement(
            (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Price,
            a.a(
              { key: "original", "data-aid": i.price, style: d.original },
              u,
              { children: t }
            )
          ),
      ...
      return this.merge({ children: h }, p);
    }
    function Oa(e) {
    ...
    function Va(e) {
      ...
      const n = (global.React || guac.react).createElement(
        (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element.Label,
        { "data-aid": a.ribbon, size: r, ribbonType: o },
        t
      );
      return this.merge({ children: n }, l);
    }
    const Na = {
      ...
      ja = { ...Na, display: "none", "@sm": { display: "flex" } },
      Fa = { ...Na, display: "none", "@xs-only": { display: "flex" } };
    function $a(e) {
      let {
        colors: t,
        renderColorsLabel: a,
    ...
    const Ga = "chevronLeft",
      ...
      Qa = {
        leftArrow: { ...Ya, left: `${Za}px` },
        rightArrow: { ...Ya, right: `${Za}px` },
      },
      Ja = (e) => {
        const {
        ...
        C = [
          {
            component: Ja,
            position: "top",
            props: { icon: Ga, currentAssetIndex: p },
          },
          {
            component: Ja,
            position: "bottom",
            props: { icon: qa, currentAssetIndex: p },
          },
        ],
    ...
    function Br(e) {
      let { children: t, sectionHeadingHR: a = Er, richtext: r, ...o } = e;
      return this.Heading(
        this.merge(
          {
            level: 2,
      ...
      return this.merge(
        {
          style: {
            ...
            lineHeight: "0",
            "@md": {
              "> :first-child": { marginLeft: t ? "medium" : a ? "small" : 0 },
            },
          },
        },
        r
    ...
    function Eo(e) {
      return this.NavLink(this.merge({ style: vo }, e));
    }
    function Ro(e) {
      return this.NavLinkActive(this.merge({ style: vo }, e));
    }
    function So(e) {
    ...
    function jo(e) {
      return this.List(this.merge({ style: { marginLeft: "medium" } }, e));
    }
    function Fo(e) {
      return this.NavLink(
    ...
    const { themeConstants: tl, renderModes: al } = (
        global.Core || guac["@wsb/guac-widget-core"]
      ).constants,
      { DISPLAY: rl } = al;
    function ol(e) {
    ...
    function Nl(e) {
      let { size: t = { xs: "large" }, ribbonType: a, ...r } = e;
      const o = {},
        l = "pill" === a ? "left" : "right",
        n = {
          paddingHorizontal: "medium",
      ...
      let i;
      "transparent" === a && ((r.category = "accent"), (r.featured = !0)),
        "roundRectangle" === a ? (i = "large") : "pill" === a && (i = "99em");
      const c = {
        position: "absolute",
        display: "block",
        backgroundColor:
      ...
      return this.DetailsMinor(
        this.merge({ style: c, category: "primary" }, r)
      );
    }
    function jl(e) {
    ...
    var Jl = (e) => {
      let { fill: t, shape: a = Zl.SQUARE } = e;
      return t === Yl.OPEN
        ? {}
        : (Zl[a] ||
    ...
    const {
      ...
      rn = { active: {}, default: {}, disabled: { opacity: "0.4" } },
      on = {
        PRIMARY: {
          color: "highlight",
      ...
      ln = { active: {}, default: {}, disabled: { opacity: "0.4" } };
    const nn = {
      [Kl.NONE]: () => ({}),
      [Kl.SOLID]: function (e, t) {
        const a = {
          active: { backgroundColor: tn[t].bgColorActive },
          default: {
            backgroundColor: tn[t].bgColorDefault,
            ":hover": { backgroundColor: tn[t].bgColorDefaultHover },
          },
          disabled: {
            backgroundColor: tn[t].bgColorDefault,
            opacity: "0.4",
            ":active": { backgroundColor: tn[t].bgColorDefault },
          },
        };
        return { color: tn[t].color, ...a[e] };
      },
      ...
      [Kl.OPEN]: function (e, t) {
        return {
          ...
          alignItems: "flex-end",
          ...ln[e],
          ":hover": { color: on[t].colorHover },
          ":active": { color: on[t].colorActive },
        };
      },
    };
    var cn = (e) => {
    ...
    const {
      buttons: { shadows: sn, fills: gn, colors: pn },
    } = (global.Core || guac["@wsb/guac-widget-core"]).constants;
    const un = {
      [sn.NONE]: () => ({}),
      [sn.SHADOW1]: function () {
    ...
    function dn(e) {
      let { fill: t, shadow: a = sn.NONE, color: r = pn.PRIMARY } = e;
      return t !== gn.SOLID && a !== sn.NONE
    ...
    const {
        buttons: { decorations: hn, fills: mn },
      } = (global.Core || guac["@wsb/guac-widget-core"]).constants,
      bn = {
        position: "unset",
        opacity: "unset",
    ...
    const {
      buttons: { shapes: xn, decorations: wn, fills: Tn },
    } = (global.Core || guac["@wsb/guac-widget-core"]).constants;
    var Pn = (e) => {
    ...
    function kn(e) {
      ...
      return this.merge(
        ...
        a,
        { style: u },
        ...[Pn, Jl, cn, Cn, dn].map((e) => e.call(this, { ...g, ...d }))
      );
    }
    function vn(e) {
      let { children: t, ...a } = e;
      const { state: r = "default", size: o = "default" } = a,
        ...
        { icon: s, iconLeft: g = !0, iconSize: p = c, ...u } = kn.call(this, a),
        d = a.btnAddon
          ? (global.React || guac.react).createElement(
              (global.Core || guac["@wsb/guac-widget-core"]).UX2.Element
                .Element,
    ...
    const En = { outline: "none", boxShadow: "inset 0 0 0 1px currentColor" };
    function Rn(e) {
      let {
        convertToAbsolute: t,
        href: a,
    ...
    function Nn(e) {
      return this.ButtonPrevious(this.merge({ style: { left: 0 } }, _n, Vn, e));
    }
    function jn(e) {
      return this.ButtonNext(this.merge({ style: { right: 0 } }, _n, Vn, e));
    }
    const Fn = {
      style: {
        backgroundColor: "transparent",
        ...
        "@md": { ":hover": { backgroundColor: "section" } },
      },
    };
    function $n(e) {
    ...
    const ti = { style: { lineHeight: "0" }, typography: "NavAlpha" };
    function ai(e) {
      return this.Link(this.merge({ ...ti }, e));
    }
    function ri(e) {
      return this.Icon(this.merge({ ...ti }, e));
    }
    function oi(e) {
    ...
    const {
      ...
      } = (global.Core || guac["@wsb/guac-widget-core"]).constants.breakpoints,
      {
        ...
        .containerWidths,
      { getImageDimensions: Ki, getOriginalImageDimensions: ec } = (
        global.Core || guac["@wsb/guac-widget-core"]
    ...
    function ic() {
      ...
      const t = 2 * e;
      return [
        { max: 450, imageMax: tc - t, width: qi },
        { min: tc, max: Oi, imageMax: Oi - t, width: qi },
        { min: _i, max: Vi, width: Zi },
        { min: Ni, max: ji, width: Yi },
        { min: Fi, max: $i, width: Qi },
        { min: Gi, width: Ji },
      ];
    }
    function cc(e) {
    ...
    const { PUBLISH: sc } = (global.Core || guac["@wsb/guac-widget-core"])
        .constants.renderModes,
      { RSS: gc, HEADER: pc } = (global.Core || guac["@wsb/guac-widget-core"])
        .constants.widgetTypes,
    ...
    function Cc(e) {
      ...
      let {
        ...
        backgroundImage: i,
        lazyLoad: c = !0,
        mobileGutterWidth: s = 24,
        isFullWidthMobile: g = !0,
        ...p
      } = e;
      const { widgetType: u, order: d } = this.base,
        {
          imageDimensionStyles: h,
          parsedImageData: m,
          enableImageDimension: b,
        } = (function () {
          let e =
            arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
          const {
          ...
          if (r)
            if (r === mt)
              ...
              const { aspectRatio: e, borderRadius: o } = ht[r] || {};
              e && t
                ? (n.outputHeight = t / e)
        ...
        { renderMode: y } = (this.base && this.base.context) || {},
        { aspectRatio: f } = uc(m),
      ...
      return (function () {
        let e =
            ...
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
          {
            ...
            ? arguments[2]
            : {};
        if (!wt(e) || !((null != t && t.imageUrl) || (null != t && t.image)))
          return r ? { ...c, ...cc(e) } : { src: e, ...c };
        const { width: s = Number.MAX_SAFE_INTEGER, height: g } = ec(t),
          p = Ki(t),
          { outputWidth: u, outputHeight: d } = t,
          { aspectRatio: h } = p,
          m = !lc(t.width) && parseInt(t.width || 0, 10),
          b = !lc(t.height) && parseInt(t.height || 0, 10),
          y = Boolean(m || b),
          f = r &&
            o && { srcSet: Rt(p, ac).join(", "), sizes: nc(ac).join(", ") },
          C = r ? { ...cc(e), ...f } : { src: e };
        if (l) return { ...C, ...c };
        const x = (global.React || guac.react).createElement(
          ...
          T = (e) =>
            n
              ? r
                ? { "data-lazyimg": !0, "data-srcsetlazy": e, ...f }
                : { srcSet: e }
              : {};
        if (!u && !d) {
          const t = [];
          ...
          const e = Dt.map((e) => {
            ...
            r = [
              e.length &&
                (global.React || guac.react).createElement(
                  "source",
                  a.a({ key: "mobile", media: "(max-width: 450px)" }, T(e))
                ),
              k.length &&
                (global.React || guac.react).createElement(
                  "source",
                  a.a({ key: "desktop", media: "(min-width: 451px)" }, T(k))
                ),
            ].filter(Boolean);
          return 1 === r.length
            ? { ...C, ...T(e || k), ...c }
        ...
        this.merge(
          {
            style: {
              ...
              verticalAlign: "middle",
              "@xs-only": w
                ? { height: `calc((100vw - ${2 * s}px)/${f})` }
                : {},
              aspectRatio: f ? `${f} / 1` : "auto",
            },
            tag: "img",
            alt: o || (global._ || guac.lodash).get(m, "alt") || l || r,
            lazyLoad: c && y === sc && !C && !x,
            mobileGutterWidth: s,
            reserveMobileHeight: w,
          },
          p,
          {
            style: b
    ...
    const Lc = (global.React || guac.react).lazy(
        () =>
      ...
      { sectionTypes: Ac } = (global.Core || guac["@wsb/guac-widget-core"])
        .constants,
      Mc = { wordWrap: "break-word", overflowWrap: "break-word" };
    function Bc(e) {
      let {
        children: t,
        tag: a,
      ...
      const { widgetType: i, widgetId: c, renderMode: s, order: g } = this.base,
        p = this.mapPropValue("lineHeightLevel", r),
        u = o ? { originalText: t } : {},
        d = "undefined" != typeof window && "PUBLISH" === s;
      let h = a ? parseInt(a.substring(1), 10) : r,
        m = !1;
      const b = Sc({ tag: a, level: r });
      if (
        this.prevWidgetId !== c &&
        h &&
        1 !== h &&
        ...
        if (d) {
          ...
          (!e ||
            (e.getAttribute("data-promoted-from") === `${h}` &&
              e.getAttribute("data-order") === `${g}`)) &&
            (m = !0);
        } else m = !0;
      m && ((n["data-promoted-from"] = h), (n["data-order"] = g), (h = 1)),
        (this.prevWidgetId = c),
        (this.hasH1 = this.hasH1 || 1 === h);
      const y =
        !n.richtext && "string" == typeof t && t.includes("\n")
          ? "pre-line"
          : void 0;
      if (n.dangerouslySetInnerHTML) {
        const { __html: e } = n.dangerouslySetInnerHTML;
        n.dangerouslySetInnerHTML = { __html: l ? `<${l}>${e}</${l}>` : e };
      } else
        n.children =
          ...
          tag: n.richtext
            ? (e) =>
                (global.React || guac.react).createElement(
                  ...
                  (global.React || guac.react).createElement(Lc, e)
                )
            : f,
          typography: {
            1: "HeadingAlpha",
    ...
    function Zc(e) {
      return this.Heading(
        this.merge({ tag: "h1", typography: "HeadingAlpha" }, e)
      );
    }
    function Yc(e) {
    ...
    const { Color: ds } = (global.Core || guac["@wsb/guac-widget-core"]).UX2
        .utils,
      hs = new ds("rgba(255,255,255,1)"),
      ms = new ds("rgba(0,0,0,1)"),
      bs = new ds("rgba(69,90,100,1)"),
      ys = new ds("#ff0000"),
      fs = new ds("rgba(0, 0, 0, 0.3)"),
      Cs = new ds("rgba(255, 255, 255, 0.3)"),
      { Color: xs } = (global.Core || guac["@wsb/guac-widget-core"]).UX2.utils,
      ws = {},
      Ts = (e, t) =>
    ...
    const { Color: Es, accessibility: Rs } = (
        global.Core || guac["@wsb/guac-widget-core"]
      ).UX2.utils,
      { PRIMARY: Ss } = (global.Core || guac["@wsb/guac-widget-core"]).constants
        .categoryTypes,
      { DEFAULT_WEBSITE_FONT_SCALES: Ls } = (
        global.Core || guac["@wsb/guac-widget-core"]
      ).constants.fontScales,
      { OVERLAY: As } = (global.Core || guac["@wsb/guac-widget-core"]).constants
        .sectionTypes,
      { AA: Ms } = (global.Core || guac["@wsb/guac-widget-core"]).constants
    ...
    function Bs() {
      const {
        ...
        o = Se.call(this, e, r) * Ls[a],
        l = cs(this, "fontDial", `${t}.weight`);
    ...
    function Is(e) {
      ...
      if (Es.contrastRatio(e, t) < a) {
        const r = (global._ || guac.lodash).first(
          (function (e, t, a) {
            let r =
            ...
            return i
              ...
              .slice(0, r)
              .map((e) => xs.fromHSV(o, e.saturation, e.value));
          })(a, t, e)
        );
        if (r) return r;
      }
    ...
    var zs = {
      ...
      colorPrimaryOverlay: function () {
        const [e, t] = ss(this, ["primary", "background"]),
    ...
    const { Color: Xs } = (global.Core || guac["@wsb/guac-widget-core"]).UX2
        .utils,
      { categoryTypes: Ds, sectionTypes: Us } = (
        global.Core || guac["@wsb/guac-widget-core"]
      ).constants;
    var Ws = {
      __proto__: null,
    ...
    const { Color: Os } = (global.Core || guac["@wsb/guac-widget-core"]).UX2
      .utils;
    var _s = {
      __proto__: null,
      ...
      backgroundColorNeutralOverlay: function () {
        const [e, t] = ss(this, ["neutral", "background"]),
          a = 100 === t.alpha ? 90 : 90 === t.alpha ? 50 : 30;
        return e.setAlpha(a);
      },
    ...
    var Fs = {
        ...
        borderColorSection: function () {
          ...
          return e.alpha < 100
            ? e.isLight()
              ? fs
              : Cs
            : e.contrast(10 * ss(this, "multiplier"), !0);
        },
        ...
        borderColorInput: function () {
          const [e, t] = ss(this, ["outline", "background"]);
          return e
            ? ps(this, "input").contrastWith(t, 10 * ss(this, "multiplier"), !0)
          ...
          (global._ || guac.lodash).reduce(
            ...
            (e, a, l) => {
              if ((global._ || guac.lodash).startsWith(l, "@"))
                e[l] = Ys({ fontSizeMap: a, children: r });
              else {
                let n;
    ...
    function Qs(e, t) {
      ...
      return (global._ || guac.lodash).merge(
        {},
        Zs.call(this, this.mappedValues.typographyMapping[e], t),
        Zs.call(
          this,
        ...
        Zs.call(this, this.mappedValues[`typography${e}`], t) || {},
        t.fontSizeMap
          ? (function (e) {
              return { style: Ys(e) };
            })(t)
      ...
      return (
        (e &&
          (t.typography && t.typography.toLowerCase()) !==
            (e && e.toLowerCase()) &&
          Qs.call(this, t.typography, t)[e.toLowerCase()]) ||
        a
      );
    }
    function Ks(e, t) {
      return e
        ? e
            ...
            .reduce(
              (e, a) =>
                (global._ || guac.lodash).merge({}, e, Qs.call(this, a, t)),
              {}
            )
        : {};
    }
        ...
        super(),
          ...
          (this.mappedValues = {
            ...
            typographyMapping: {
              ...
              SubNavGamma: (e) =>
                (global._ || guac.lodash).merge(Qs.call(this, "NavGamma", e), {
                  style: { color: "section" },
                }),
              ButtonAlpha: (e) => {
              ...
              Featured: (e) =>
                Js.call(this, "featured", e, {
                  style: { color: "highContrast" },
                }),
              Alert: (e) =>
                Js.call(this, "alert", e, { style: { color: "error" } }),
              Disabled: (e) => {
                const t = {
                  style: {
                    color: "inputDisabled",
              ...
              Active: (e) =>
                Js.call(this, "active", e, { style: { fontWeight: "bold" } }),
            },
            typography: (t) =>
              function () {
                let a =
