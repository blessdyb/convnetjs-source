  ...
  return (
    ...
    (i.m = n =
      [
        ...
        function (t, e, n) {
          "use strict";
          e.getWindow = e.getBaseHost = undefined;
          var r = (function t(e) {
          ...
          var i,
            ...
            s =
              ...
              "undefined" == typeof window
                ? { window: u, document: o, navigator: a }
                : {
                    window: window || u,
          ...
          (function t(e, n, r) {
            ...
            if (n && !(10 < i)) {
              var o = e(n);
              return !o && n.parentNode ? t(e, n.parentNode, i + 1) : o;
            }
          });
          (e.getBaseHost = l),
            (e.getWindow = c),
            function t(e) {
              for (
                var n = e.split(";"), r = Object.create(null), i = 0;
                i < n.length;
                i++
              ) {
                var o = /([^=]*)*=([\s\S]*)/.exec(n[i]);
              ...
              if (0 < u.timeToInteractive)
                if (window._tccInternal)
                  ...
                  var t = (function t(e) {
                    ...
                    e = Object.assign({}, u, t ? { usrin: t } : {});
                  setTimeout(function () {
                    return window._trfq.push(["cmdLogPerf", e]);
                  }, 0);
                }
            },
            c = function () {
              var t =
                ...
                n = t.value;
              if (
                ((u[e] = "CLS" === e ? n : Math.round(n)),
                "timeToInteractive" === e)
              )
                if (u.hasOwnProperty("FID")) s();
                else
                  var r = 0,
                    i = setInterval(function () {
                      (u.hasOwnProperty("FID") || 10 < r) &&
                        (i && (clearInterval(i), (i = null)), s()),
                        (r += 1);
                    }, 500);
            };
          (e.calculateTTI = function () {
            ...
            try {
              (0, i.getLCP)(e, !0),
                (0, i.getFID)(e),
                (0, i.getCLS)(e, !0),
                (0, r.getFirstConsistentlyInteractive)().then(function (t) {
            ...
            (e._collectVitals = c),
            (e._sendWebVitalsData = s),
            (e.setCustomProperties = function () {
              var t =
                0 < arguments.length && arguments[0] !== undefined
                  ? arguments[0]
                  : {};
              return (a = Object.assign({}, a, t));
            });
        },
        function (t, e, n) {
          "use strict";
          t.exports = n(5).polyfill();
        },
        function (t, e, n) {
          var rt, it;
          (rt = n(6)),
            ...
            (t.exports = (function () {
              ...
              return (
                ...
                (et.resolve = P),
                (et.reject = function t(e) {
                  var n = new this(x);
                  return H(n, e), n;
                }),
                (et._setScheduler = function t(e) {
                  o = e;
                }),
                (et._setAsap = function t(e) {
                  u = e;
                }),
                (et._asap = u),
                (et.polyfill = function t() {
                  var e = void 0;
                  if (void 0 !== it) e = it;
                  else if ("undefined" != typeof self) e = self;
                  else
        ...
        function (y, g, t) {
          ...
          (w = t(0)),
            (function () {
              ...
              function r() {
                (r = function () {}), n.Symbol || (n.Symbol = t);
              }
              var i = 0;
              function t(t) {
              ...
              function u(t) {
                ...
                return (function t(e) {
                  return (
                    o(),
                    ((e = { next: e })[n.Symbol.iterator] = function () {
                      return this;
                    }),
                    e
                  );
              ...
              function l(t, e) {
                for (var n = (t = a(t)).next(); !n.done; n = t.next())
                  if (
                    ((n = n.value),
                    e.includes(n.nodeName.toLowerCase()) || l(n.children, e))
                  )
                    return 1;
              }
              function d(t, e) {
                if (2 < t.length) return performance.now();
                for (var n = [], r = (e = a(e)).next(); !r.done; r = e.next())
                  (r = r.value),
                    n.push({ timestamp: r.start, type: "requestStart" }),
                    n.push({ timestamp: r.end, type: "requestEnd" });
                for (r = (e = a(t)).next(); !r.done; r = e.next())
                  ...
                  this.w &&
                    (this.h = (function t(n) {
                      var e = new MutationObserver(function (t) {
                        for (var e = (t = a(t)).next(); !e.done; e = t.next())
                          (("childList" == (e = e.value).type &&
                            l(e.addedNodes, f)) ||
                            ("attributes" == e.type &&
                              f.includes(e.target.tagName.toLowerCase()))) &&
                            n(e);
                      });
                      return (
                        e.observe(document, {
              ...
              (p.prototype.getFirstConsistentlyInteractive = function () {
                ...
                (p.prototype.l = function (t) {
                  this.f.delete(t);
                }),
                (p.prototype.B = function () {
                  h(this, performance.now() + 5e3);
                }),
                n.Object.defineProperties(p.prototype, {
                  g: {
                    configurable: !0,
                    enumerable: !0,
                    get: function () {
                ...
                getFirstConsistentlyInteractive: function (t) {
                  return (
                    ...
                    "PerformanceLongTaskTiming" in window
                      ? new p(t).getFirstConsistentlyInteractive()
        ...
        function (t, e, n) {
          ...
          var a,
            ...
            v = new ("function" == typeof WeakSet ? WeakSet : Set)(),
            h = function (t, e, n) {
              var r;
              return function () {
                0 <= e.value &&
                  (n || v.has(e) || "hidden" === document.visibilityState) &&
                  ((e.delta = e.value - (r || 0)),
                ...
                a = function (t) {
                  if (!t.hadRecentInput) {
                    ...
                    t.startTime - e.startTime < 5e3
                      ? ((o += t.value), u.push(t))
                      : ((o = t.value), (u = [t])),
                      o > i.value && ((i.value = o), (i.entries = u), r());
                  }
                },
                s = l("layout-shift", a);
              s &&
                ((r = h(n, i, t)),
                d(function () {
                  s.takeRecords().map(a), r();
                }),
                p(function () {
                  (w = -1), (i = f("CLS", (o = 0))), (r = h(n, i, t));
                }));
            },
              ...
              if (t.cancelable) {
                ...
                "pointerdown" == t.type
                  ? ((n = e),
                    ...
                    (u = function () {
                      removeEventListener("pointerup", i, _),
                        removeEventListener("pointercancel", o, _);
                    }),
                    addEventListener("pointerup", i, _),
                    addEventListener("pointercancel", o, _))
                  : S(e, t);
              }
              var n, r, i, o, u;
            },
            ...
            j = function (e, n) {
              var r,
                ...
                t = function (t) {
                  var e = t.startTime;
                  e < i.firstHiddenTime && ((o.value = e), o.entries.push(t)),
                    r();
                },
                u = l("largest-contentful-paint", t);
              if (u) {
                r = h(e, o, n);
                var a = function () {
                  v.has(o) ||
                    (u.takeRecords().map(t), u.disconnect(), v.add(o), r());
                };
            ...
            r =
              ...
              (function () {
                for (var t = arguments.length, e = Array(t), n = 0; n < t; n++)
                  e[n] = arguments[n];
                var r = (0, o.getWindow)().console;
                return !(0, i.isProduction)() && r && r.error
                  ? Function.prototype.bind
        ...
        function (t, e, n) {
          "use strict";
          e.isProduction = e.isDebug = undefined;
          var r = n(1),
            i = n(13),
            o = function (t) {
              ...
              return (
                !e ||
                (0, i.startsWith)(e, "dev-") ||
                (0, i.startsWith)(e, "localhost") ||
                (0, i.startsWith)(e, "dev.") ||
                (0, i.startsWith)(e, "test.")
              );
            },
            u = function (t) {
              var e = (0, r.getBaseHost)(t);
              return (
                (0, i.startsWith)(e, "test-") || (0, i.startsWith)(e, "stg-")
              );
            },
            a = function () {
              return !o() && !u();
          ...
          var r =
            ...
            (o.prototype.getProperties = function (t) {
              ...
              return (
                ...
                (0, i.map)(this.properties, function (t, e) {
                  r(t) || (n[t] = e);
                }),
                n
              );
            ...
            (o.prototype.merge = function (t) {
              var n = this,
                e = t;
              e instanceof o && (e = t.getProperties()),
                (0, i.map)(e, function (t, e) {
                  n.set(t, e);
                });
            }),
            o);
