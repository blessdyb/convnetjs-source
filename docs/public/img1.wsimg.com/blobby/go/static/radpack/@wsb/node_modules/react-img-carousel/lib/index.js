...
var _areChildImagesEqual = _interopRequireDefault(
  require("./utils/areChildImagesEqual")
);
...
class Carousel extends _react.Component {
  static get propTypes() {
    return {
      ...
      arrows: _propTypes.default.oneOfType([
      ...
      autoplaySpeed: _propTypes.default.oneOfType([
        _propTypes.default.number,
        _propTypes.default.string,
      ]),
      lazyLoad: _propTypes.default.bool,
      controls: _propTypes.default.arrayOf(
        _propTypes.default.shape({
      ...
      easing: _propTypes.default.oneOf([
        "ease",
        "linear",
        "ease-in",
        "ease-out",
  ...
  constructor(props) {
    ...
    (0, _defineProperty2.default)(
      this,
      "goToSlide",
      (index, direction, autoSlide = false) => {
        const {
          beforeChange,
          transitionDuration,
          transition,
    ...
    (0, _defineProperty2.default)(this, "calcLeftOffset", (retryCount = 0) => {
      ...
      for (let i = 0; i < slides.length; i++) {
        ...
        isCurrentSlideLoading =
          selectedSlide.className.indexOf(LOADING_CLASS) !== -1;
        currentSlideWidth = selectedSlide.offsetWidth;
        foundZeroWidthSlide =
          foundZeroWidthSlide || (!currentSlideWidth && !isCurrentSlideLoading);

        if (
          parseInt(selectedSlide.getAttribute("data-index"), 10) ===
          currentSlide
        ) {
          break;
        }
      ...
      if (shouldRetry) {
        this._retryTimer = setTimeout(
          this.calcLeftOffset.bind(this, ++retryCount),
          10
        );
        return;
      }
    ...
    (0, _defineProperty2.default)(this, "onTouchMove", (e) => {
      ...
      const angle =
        (Math.abs(Math.atan2(screenY - y, screenX - x)) * 180) / Math.PI;
      this._prevPos = {
        x: screenX,
        y: screenY,
      };
    ...
    (0, _defineProperty2.default)(this, "stopDragging", () => {
      ...
      if (isQuickSwipe || percentDragged > dragThreshold) {
        ...
        duration = Math.min(
          swipeSpeed * (1 - percentDragged) * viewportWidth,
          (0, _ms.default)("" + transitionDuration) * (1 - percentDragged)
        );
      } else {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    const { currentSlide, loadedImages, direction, loading, slideDimensions } =
      this.state;
    ...
    if (
      !(0, _areChildImagesEqual.default)(
        _react.Children.toArray(children),
        _react.Children.toArray(oldChildren)
      )
    ) {
  ...
  fetchImages() {
    ...
    const imagesToPrefetch = Math.min(
      this.props.imagesToPrefetch,
      slides.length
    );
  ...
  render() {
    ...
    const containerStyle = { ...(style.container || {}), width, height };
    ...
    if (transition !== "fade") {
      ...
      trackStyle = {
        ...
        transition: transitionDuration
          ? `transform ${(0, _ms.default)("" + transitionDuration)}ms ${easing}`
          : "none",
      };
    }
      ...
      /*#__PURE__*/ _react.default.createElement(
        ...
        controls
          ...
          .map((Control, index) =>
            /*#__PURE__*/ _react.default.createElement(
              Control.component,
              (0, _extends2.default)({}, Control.props, {
                key: `control-${index}`,
  ...
  renderSlides() {
    ...
    let childrenToRender = _react.Children.map(children, (child, index) => {
      ...
      if (transition === "fade") {
        slideStyle.transition = `opacity ${(0, _ms.default)(
          "" + transitionDuration
        )}ms ${easing}`;
      }
      ...
      if (
        !lazyLoad ||
        (imgSrc ? !!loadedImages[imgSrc] : slidesToRender.indexOf(index) > -1)
      ) {
  ...
  getIndicesToRender() {
    ...
    let indices = genIndices(
      currentSlide - prevSlidesToRender,
      currentSlide + nextSlidesToRender
    );
    ...
    if (transitioningFrom !== null) {
      ...
      indices = indices.concat(
        genIndices(
          transitioningFrom - prevSlidesToRender,
          transitioningFrom + nextSlidesToRender
        )
      );
    }
  ...
  addClones(originals) {
    ...
    const originalsToClone = [
      (0, _nth.default)(originals, numOriginals - 2),
      (0, _nth.default)(originals, numOriginals - 1),
      (0, _nth.default)(originals, 0),
      (0, _nth.default)(originals, Math.min(1, numOriginals - 1)),
    ];
    const prependClones = [
      /*#__PURE__*/ (0, _react.cloneElement)(originalsToClone[0], {
        key: "clone-1",
        "data-index": -2,
        className: originalsToClone[0].props.className.replace(
          SELECTED_CLASS,
          ""
        ),
      }),
      /*#__PURE__*/ (0, _react.cloneElement)(originalsToClone[1], {
        key: "clone-0",
        "data-index": -1,
        className: originalsToClone[1].props.className.replace(
          SELECTED_CLASS,
          ""
        ),
      }),
    ...
    const appendClones = [
      /*#__PURE__*/ (0, _react.cloneElement)(originalsToClone[2], {
        key: "clone-2",
        "data-index": numOriginals,
        className: originalsToClone[2].props.className.replace(
          SELECTED_CLASS,
          ""
        ),
      }),
      /*#__PURE__*/ (0, _react.cloneElement)(originalsToClone[3], {
        ...
        className: originalsToClone[3].props.className.replace(
          SELECTED_CLASS,
          ""
        ),
      }),
