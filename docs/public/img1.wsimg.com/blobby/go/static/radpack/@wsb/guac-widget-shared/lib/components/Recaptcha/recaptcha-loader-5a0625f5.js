define(
  "@wsb/guac-widget-shared/lib/components/Recaptcha/recaptcha-loader-5a0625f5.js",
  ...
  function (e, t) {
    ...
    function i(e, t) {
      let { siteKey: a } = e;
      var i;
      (c(), void 0 !== window.grecaptcha && window.grecaptcha.execute)
        ? t()
        : ((i = t),
          window.wsb.recaptcha.scriptCallbacks.push(i),
    ...
    class n extends (global.React || guac.react).Component {
      ...
      componentDidMount() {
        (this.execute = this.props.onComplete),
          a(this.siteKeyUrl, this.loadRecaptcha);
      }
      get siteKeyUrl() {
    ...
    (n.propTypes = {
      ...
      (n.defaultProps = { formSubmitEndpoint: "/v3/recaptcha" }),
      (e.default = n),
