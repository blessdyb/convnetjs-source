...
var _draftJsUtils = require("@wsb/draft-js-utils");
...
var DEFAULT_STYLE_MAP =
  ((_DEFAULT_STYLE_MAP = {}),
  _defineProperty(_DEFAULT_STYLE_MAP, BOLD, { element: "strong" }),
  _defineProperty(_DEFAULT_STYLE_MAP, CODE, { element: "code" }),
  _defineProperty(_DEFAULT_STYLE_MAP, ITALIC, { element: "em" }),
  _defineProperty(_DEFAULT_STYLE_MAP, STRIKETHROUGH, { element: "del" }),
  _defineProperty(_DEFAULT_STYLE_MAP, UNDERLINE, { element: "u" }),
  _DEFAULT_STYLE_MAP);
...
var DATA_TO_ATTR =
  ...
  _defineProperty(
    _DATA_TO_ATTR,
    _draftJsUtils.ENTITY_TYPE.LINK,
  ...
  _defineProperty(
    _DATA_TO_ATTR,
    _draftJsUtils.ENTITY_TYPE.IMAGE,
    function (entityType, entity) {
      var attrMap = ENTITY_ATTR_MAP.hasOwnProperty(entityType)
        ? ENTITY_ATTR_MAP[entityType]
        : {};
...
var MarkupGenerator = (function () {
  ...
  function MarkupGenerator(contentState, options) {
    ...
    var _combineOrderedStyles = (0, _combineOrderedStyles4.default)(
  ...
  _createClass(MarkupGenerator, [
      ...
      value: function processBlock() {
        ...
        var customRenderer =
          blockRenderers != null && blockRenderers.hasOwnProperty(blockType)
            ...
            : null;
        var customRendererOutput = customRenderer
    ...
    },
    {
      ...
      value: function writeStartTag(block, defaultBlockTag) {
        ...
        if (this.options.blockStyleFn) {
          ...
          if (_style != null) {
            ...
            _attributes =
              _attributes == null
                ? { style: styleAttr }
                : _extends({}, _attributes, { style: styleAttr });
          }
        ...
        try {
          for (
            var _iterator3 = tags[Symbol.iterator](), _step3;
    ...
    },
    {
      ...
      value: function writeEndTag(block, defaultBlockTag) {
        ...
        if (tags.length === 1) {
          ...
          try {
            for (
              var _iterator4 = tags[Symbol.iterator](), _step4;
    ...
    },
    {
      ...
      value: function withCustomInlineStyles(content, styleSet) {
        ...
        var _renderConfig$element = renderConfig.element,
          element =
            _renderConfig$element === undefined
              ? "span"
        ...
        return (
          "<" + element + attrString + ">" + content + "</" + element + ">"
        );
      },
    },
    {
      ...
      value: function renderBlockContent(block) {
        ...
        var entityPieces = (0, _draftJsUtils.getEntityRanges)(
          text,
          charMetaList
        );
        return entityPieces
          .map(function (_ref2) {
            ...
            var content = stylePieces
              .map(function (_ref4) {
                ...
                try {
                  for (
                    var _iterator5 = _this.styleOrder[Symbol.iterator](),
                      _step5;
                    ...
                    if (
                      _styleName === CODE &&
                      blockType === _draftJsUtils.BLOCK_TYPE.CODE
                    ) {
                      continue;
                    }
                    if (styleSet.has(_styleName)) {
                      var _inlineStyles$_styleN =
                          _this.inlineStyles[_styleName],
                      ...
                      // Normalize `className` -> `class`, etc.
                      _attributes2 = (0, _normalizeAttributes2.default)(
                        _attributes2
                      );
                      if (_style2 != null) {
                        ...
                        _attributes2 =
                          _attributes2 == null
                            ? { style: styleAttr }
                            : _extends({}, _attributes2, { style: styleAttr });
                      }
            ...
            var entity = entityKey
              ? _this.contentState.getEntity(entityKey)
              : null;
            // Note: The `toUpperCase` below is for compatability with some libraries that use lower-case for image blocks.
            var entityType =
              entity == null ? null : entity.getType().toUpperCase();
            ...
            if (
              ...
              if (_style3 != null) {
                ...
                _attributes3 =
                  _attributes3 == null
                    ? { style: styleAttr }
                    : _extends({}, _attributes3, { style: styleAttr });
              }
              ...
              entityType != null &&
              entityType === _draftJsUtils.ENTITY_TYPE.LINK
            ) {
              ...
              entityType != null &&
              entityType === _draftJsUtils.ENTITY_TYPE.IMAGE
            ) {
...
function stringifyAttrs(attrs) {
  ...
  try {
    for (
      var _iterator6 = Object.keys(attrs)[Symbol.iterator](), _step6;
